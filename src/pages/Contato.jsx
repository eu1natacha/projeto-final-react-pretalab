...
export function Contato() {
  ...
  function createMessage(event) {
    ...
    //tabela de mensagens (dentro do firebase)
    const mensagensListRef = ref (database, 'mensagens')

    //criar uma nova mensagem (dentro da tabela de mensagens)
    const novaMensagemRef = push(mensagensListRef)

    //Dizer o que vai na mensagem
    set(novaMensagemRef, {
      nome: nome,
      email: email,
      texto:mensagem
  ...
  return(
    <>
      <Header text="Fale comigo!" image={contatoImg} />
